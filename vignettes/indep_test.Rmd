...
We propose a simple dependence measure $\nu(Y, \mathbf{X})$ ([*A new measure of dependence: Integrated $R^2$*](https://arxiv.org/pdf/1910.12327.pdf).) to assess how much a random variable $X$ explains a univariate response $Y$.
